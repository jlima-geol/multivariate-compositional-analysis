...
Please note that data intrepretation is not included here. For the interpretation of a real-world geochemical dataset, refer to Chapter 6 - Multivariate Analysis of the thesis:
